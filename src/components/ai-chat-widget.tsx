        ...
        <div className="p-4 border-b border-gray-200 bg-gray-50 space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#0d7377] text-white rounded text-sm hover:bg-[#0a5c5f] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isSearching && (
                ...
                <div className="space-y-2">
                  ...
                  {searchHasMore && (
                    <button
                      ...
                      className="w-full py-2 text-xs text-[#0d7377] hover:bg-gray-100 rounded border border-gray-200 disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                      {isSearching && (
                        <svg className="animate-spin h-3 w-3 text-[#0d7377]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                          <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                          <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                      )}
