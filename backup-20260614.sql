...
CREATE TABLE IF NOT EXISTS "public"."cfu_assets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "image_url" "text" NOT NULL,
    "asset_type" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "cfu_assets_asset_type_check" CHECK (("asset_type" = ANY (ARRAY['background'::"text", 'png'::"text"])))
);


ALTER TABLE "public"."cfu_assets" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."cfu_assets"
    ADD CONSTRAINT "cfu_assets_pkey" PRIMARY KEY ("id");
...
CREATE POLICY "Admin full access to cfu_assets" ON "public"."cfu_assets" TO "authenticated" USING (true) WITH CHECK (true);
...
ALTER TABLE "public"."cfu_assets" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."cfu_assets" TO "anon";
GRANT ALL ON TABLE "public"."cfu_assets" TO "authenticated";
GRANT ALL ON TABLE "public"."cfu_assets" TO "service_role";
